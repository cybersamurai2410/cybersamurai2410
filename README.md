...
- **[Fine-Tuning Mixture-of-Experts (MoE) using MixLoRA for Language Style Transfer](https://github.com/cybersamurai2410/moe-mixlora)** - Fine-tuned MoE using MixLoRA targetting only the expert layers to convert regular English into different styles. <!--https://medium.com/@prakharsaxena11111/finetuning-mixtral-7bx8-6071b0ebf114-->
...
- **[Multimodal Mixture-of-Experts Model from Fine-Tuned Vision Transformers](https://github.com/cybersamurai2410/moe-vit)** - Developed multimodal MoE model from multiple fine-tuned vision transformer models for generating detailed image captions. <!--https://huggingface.co/blog/mjbuehler/phi-3-vision-cephalo-moe | https://huggingface.co/blog/mlabonne/frankenmoe-->
...
- **[Fine-Tuning Vision Transformer (ViT) for Image Classification](https://github.com/cybersamurai2410/vit-img-classification)** - Fine-Tuned ViT from the encoder to tokenize images for classification by splitting into grid of sub-image patches and embedding with linear projection. <!--https://huggingface.co/blog/fine-tune-vit--> 
