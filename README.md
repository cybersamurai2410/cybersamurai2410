...
- **[Chatbot using Agentic RAG](https://github.com/cybersamurai2410/Document-Chatbot/)** - Application using LLMs with RAG (retrieval augemented generation) allowing users to interact with the chatbot UI retrieving context embeddings using vector databases extracted from external sources including PDF, CSV, SQL, Websites and YouTube Videos.
