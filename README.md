...
- **[Anomaly Detection in Urban Traffic using Graph Variational Autoencoders](https://github.com/cybersamurai2410/graphvae-traffic-anomaly-detection)** - Implemented GraphVAE trained on the METR-LA dataset with GCN-based encoder-decoder architecture for modeling spatiotemporal sensor patterns and detecting anomalies in traffic through reconstruction error.
- **[Hybrid Graph Neural Networks for Movie Recommendation](https://github.com/cybersamurai2410/hybrid-gnn-movie-rec)** - Graph-based movie recommendation system using a hybrid NGCF + R-GCN architecture. Constructed a heterogeneous graph from IMDb and MovieLens datasets linking users, movies and associated entities (actors, directors, genres).
